...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Adhérents<span class="fa arrow"></span></a>
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Oeuvres<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
